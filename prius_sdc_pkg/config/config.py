...
vid_path = os.path.abspath("/home/ayush-singh/Videos/FinProjectCamera/output.avi")
loopCount=0
...
in_q = cv2.VideoWriter( os.path.abspath("/home/ayush-singh/Videos/FinProjectCamera/in_new.avi") , cv2.VideoWriter_fourcc('M','J','P','G'), 30, (Resized_width,Resized_height))
out  = cv2.VideoWriter( os.path.abspath("/home/ayush-singh/Videos/FinProjectCamera/out_new.avi") , cv2.VideoWriter_fourcc('M','J','P','G'), 30, (Resized_width,Resized_height))
